document.addEventListener("DOMContentLoaded", function () {
  ...
  const helpLink = document.querySelector('.links a[href="#"]:nth-child(2)');
  const privacyLink = document.querySelector('.links a[href="#"]:nth-child(3)');
  ...
  [helpPopup, privacyPopup].forEach((modal) => {
